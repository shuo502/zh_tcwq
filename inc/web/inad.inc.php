...
$pagesize=10;
$sql="select * from".tablename('zhtc_ad')." where uniacid={$_W['uniacid']} and cityname='{$_COOKIE["cityname"]}' ORDER BY orderby ASC";
$total=pdo_fetchcolumn("select count(*) from".tablename('zhtc_ad')." where uniacid={$_W['uniacid']} and cityname='{$_COOKIE["cityname"]}' ");
