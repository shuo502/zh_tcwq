...
$pagesize=10;
$sql="select * from".tablename('zhtc_nav')." where uniacid={$_W['uniacid']} ORDER BY orderby ASC";
$total=pdo_fetchcolumn("select count(*) from".tablename('zhtc_nav')." where uniacid={$_W['uniacid']} ");
